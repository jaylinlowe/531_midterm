...
Xinhe worked on the average vowels section, adding both the code and explanations. She also contributed to the discussion section.

Yiheng Xiang wrote the average length of babynames section and came up with the idea that we can use spectral analysis to investigate the cycles in the three models.
